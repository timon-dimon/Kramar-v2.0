...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDUKrWunL56Fd8AIeKsjSrtH5zV8rBX34Q"></script>
<script type="text/javascript">
  function initialize() {
		var mapOptions = {
    	zoom: 16,
    	//center: { lat: 55.820239, lng: 37.857605}
    	center: new google.maps.LatLng(55.820239, 37.857605),
    	panControl: false,
			zoomControl: true,
			scaleControl: false,
			scrollwheel: false
